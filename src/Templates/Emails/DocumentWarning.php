...
<head>
    ...
    <title><?= __('Moloni document warning', 'moloni_es') ?></title>
    <meta name="description" content="<?= __('Document Warning Email Template.', 'moloni_es') ?>">
    <style type="text/css">
        a:hover {
                            ...
                            <tr>
                                <td style="padding:0 35px;">
                                    <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:28px;font-family:'Rubik',sans-serif;">
                                        <?= __('Moloni document warning', 'moloni_es') ?>
                                    </h1>
                                    <span style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                    <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                        <?= __('A document was created as draft because the order and document values do not match.', 'moloni_es') ?>
                                    </p>
                                    <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                        <?= __('Please check the resulting document.', 'moloni_es') ?>
                                    </p>
                                    <br>
                                    <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                        <?= $extra ?? '' ?>
